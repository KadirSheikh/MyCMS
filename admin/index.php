                ...
                <div class="col-lg-12">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-md-6">
                           <h3 class="text-primary">My Posts</h3>
                            <div class="panel panel-primary">
                                ...
                                <div class='huge'><?php echo $post_count = getUserPost(); ?></div>
                        ...
                        <div class="col-lg-4 col-md-6">
                           <h3 class="text-success">My Comments</h3>
                            <div class="panel panel-green">
                                <div class="panel-heading">
                                    <div class="row">
                                        ...
                                        <div class="col-xs-9 text-right">
                                            <div class='huge'><?php echo $comment_count = getUserComment(); ?></div>
                        ...
                        <div class="col-lg-4 col-md-6">
                           <h3 class="text-danger">My Categories</h3>
                            <div class="panel panel-red">
                                <div class="panel-heading">
                                    <div class="row">
                                        ...
                                        <div class="col-xs-9 text-right">
                                            <div class='huge'><?php echo $catogery_count = getUserCatagory(); ?></div>
      ...
      function drawChart() {
        var data = google.visualization.arrayToDataTable([
          ['Data', 'Count'],
            ...
            $arr_element = ['All Posts','Published Posts','Draft Posts' , 'Comments','Pending Comments', 'Categories'];
            $arr_element_count = [$post_count, $published_post_count ,$draft_post_count , $comment_count, $pending_comments_count , $catogery_count];
